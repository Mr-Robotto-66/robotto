...
### Step 2: Modify the Code (Required)

You must add special handling in two files to pull the contact fields:

#### 2a. Edit `analysis/stakeholders.py`

Find the `_init_stakeholder_fields` method (around line 47) and add your field list:
...
def _init_stakeholder_fields(self):
    ...
    # Add your new stakeholder type
    self.your_type_fields = ['YOUR_ID_FIELD', 'CONTACT_NAME', 'ADDRESS',
                              'CITY', 'PROVINCE', 'POSTAL_CODE']
```

Find the `find_overlapping_stakeholders` method (around line 220) and add your type:
...
#### 2b. Edit `contacts/contact_builder.py`
